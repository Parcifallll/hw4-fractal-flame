# Академия Бэкенда - рефактор задач осеннего семестра
...
* +10 бонусных баллов, если реализуете поддержку логарифмической гамма-коррекции (описано в (статье)[https://flam3.com/flame_draves.pdf]):
...
* +10 бонусных баллов, если вы добавите поддержку симметрии в генерации пламени (описано в (статье)[https://flam3.com/flame_draves.pdf]):
