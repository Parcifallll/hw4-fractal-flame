...
* Реализовано 10 трансформаций (+10 баллов)
* добавлена поддержка логарифмической гамма-коррекции (+10 баллов)
* Поделился сгенерированными фракталами в группе (+10 баллов)
* ![img_3.png](img_3.png)
* ![img_4.png](img_4.png)
